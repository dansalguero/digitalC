...
Route::middleware([
    ...
    Route::get('/communities/pendingdebtsforcommunity/', $controller_path . '\pages\communities@pendingdebtsforcommunity')->name('pages-communities-pendingdebtsforcommunity');
    Route::get('/communities/paiddebtsforcommunity/', $controller_path . '\pages\communities@paiddebtsforcommunity')->name('pages-communities-paiddebtsforcommunity');
    ...
    Route::post('/debts/storeglobal/', $controller_path . '\pages\debts@storeglobal')->name('pages-debts-storeglobal');
